...
const templates = {
	...
	'test': fs.readFileSync(path.join(templateDir, 'test.js'), { encoding: 'utf8' }),
	'config': fs.readFileSync(path.join(templateDir, 'config.json'), { encoding: 'utf8' }),
	'jasmine': fs.readFileSync(path.join(templateDir, 'jasmine.json'), { encoding: 'utf8' }),
	'package': fs.readFileSync(path.join(templateDir, 'package.json'), { encoding: 'utf8' }),
	'helper': fs.readFileSync(path.join(templateDir, 'SpecHelper.js'), { encoding: 'utf8' }),
};
